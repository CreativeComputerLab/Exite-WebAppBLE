...
const fullTranslationTable = {
  en: {
    say_this: 'Say This',
    find_robots: 'Find micro:bits',
    finding_robots: 'Finding micro:bits',
    connected: 'Connected',
  ...
  de: {
    say_this: 'Sage',
    find_robots: 'Suche micro:bits',
    finding_robots: 'Suche micro:bits',
    connected: 'Verbunden',
  ...
  pt: {
    say_this: 'Diga Isso',
    find_robots: 'Encontre micro:bits',
    finding_robots: 'Encontrando micro:bits',
    connected: 'Conectado',
  ...
  fr: {
    say_this: 'Dites ceci',
    find_robots: 'Trouvez des micro:bits',
    finding_robots: 'Trouver des micro:bits',
    connected: 'Connecté',
  ...
  nl: {
    say_this: 'Zeg Dit',
    find_robots: 'Zoek Naar micro:bits',
    finding_robots: 'Zoeken Naar micro:bits',
    connected: 'Verbonden',
  ...
  da: {
    say_this: 'Sig dette',
    find_robots: 'Find micro:bits',
    finding_robots: 'Finder micro:bits',
    connected: 'Forbundet',
  ...
  es: {
    say_this: 'Decir esto',
    find_robots: 'Encontrar micro:bits',
    finding_robots: 'Encontrando micro:bits',
    connected: 'Conectado',
  ...
  ca: {
    ...
    find_robots: 'Cerca micro:bits',
    finding_robots: 'Cercant micro:bits',
    connected: 'Connectat',
    ...
    say_this: 'Sano tämä',
    find_robots: 'Etsi micro:bits',
    finding_robots: 'Etsii micro:bits',
  ...
  sv: {
    say_this: 'Säg detta',
    find_robots: 'Hitta micro:bits',
    finding_robots: 'Hittar micro:bits',
    connected: 'Kopplade',
